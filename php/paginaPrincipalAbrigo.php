<html>
    ...
    <body>
        ...
        <ol id="liPata" class="OlSubMenu">
            ...
            <li class="liCadastrar" onclick="location.href='cadastroAnimalAbrigo.php'"> Cadastrar Novo Animal </li>
            <li class="lisSubMenus" onclick="location.href='listarDadosPublAbrigo.php'"> Editar Cadastrados </li>
